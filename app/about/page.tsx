    ...
    */
    ...
    return (
      <>
        ...
        <ul>
        <li><b>Expertise:</b> <p>Our team comprises skilled detailers who take pride in their craft.</p></li>
        <li><b>Convenience:</b> <p>As a mobile detailing service, we come to you, saving you time and effort.</p></li>
        <li><b>Quality Assurance:</b> <p>We are committed to your satisfaction, ensuring every detail meets our high standards.</p></li>
        <li><b>Passion:</b> <p>We share your love for vehicles, and it reflects in our work.</p></li>
        </ul>
